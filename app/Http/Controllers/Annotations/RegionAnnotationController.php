 ...
 * @OA\GET(
 *     path="/api/regions/{id}",
 *     summary="Afficher les informations d'une region",
 *     description="",
 *         security={
 *    {       "BearerAuth": {}}
 *         },
...
*/
 ...
 class RegionAnnotationController {}
