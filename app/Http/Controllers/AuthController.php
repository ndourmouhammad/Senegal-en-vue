...
class AuthController extends Controller
{
    ...
    public function inscrire(RegisterUserRequest $request)
    {
    ...
    // Refresh API - POST
    public function actualiserJeton()
    {
    ...
    public function afficherInformationsUtilisateurConnecte(Request $request)
    {
        $user = $request->user();
        $user->load('roles'); // Load roles with the user
    ...
    public function afficherDetailsUtilisateur($id)
    {
    ...
    public function nombreTouriste()
    {
    ...
    // Noter un guide
    public function noterGuide(Request $request, User $guide)
    {
    ...
    // Afficher les users avec le role guide
    public function listerGuides()
    {
        $guides = User::whereHas('roles', function ($query) {
            $query->where('name', 'guide');
        })->get();
        return $this->customJsonResponse('Liste des guides', $guides);
    }

    // Afficher les informations d'un guide
    public function afficherDetailsGuide($id)
    {
        $guide = User::with('roles')->find($id);
        return $this->customJsonResponse('Guide', $guide);
    }
}
